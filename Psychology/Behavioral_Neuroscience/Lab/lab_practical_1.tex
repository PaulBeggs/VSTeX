...
\begin{itemize}
    \item \cyanit{Hypoglossal Nerve} - Located at the ventral medulla, controls tongue movement.
    \item \cyanit{Glossopharyngeal / Vagus Nerve} - Found laterally on the medulla, involved in autonomic and sensory functions.
    \item \cyanit{Auditory (Vestibulocochlear) / Facial Nerve} - Located near the pons, involved in hearing and facial expressions.
    \item \cyanit{Abducens Nerve} - Controls lateral eye movement, located near the pons-medulla junction.
    \item \cyanit{Trochlear Nerve} - Involved in eye movement, emerges dorsally from the brainstem.
    \item \cyanit{Trigeminal Nerve} - Large nerve at the pons, responsible for facial sensation and chewing.
    \item \cyanit{Oculomotor Nerve} - Controls most eye movements, located at the midbrain.
    \item \cyanit{Optic Nerve} - Transmits visual information, connects to the optic chiasm.
\end{itemize}