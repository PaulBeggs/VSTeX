...
\begin{coloredlist}
    ...
    \begin{coloredlist}
        ...
        \begin{coloredlist}
            \item \cyanit{Peyote Cactus} -- Mescaline
        \end{coloredlist}
    ...
    \begin{coloredlist}
        ...
        \begin{coloredlist}
            ...
            \begin{coloredlist}
                ...
                \begin{coloredlist}
                    \item \cyanit{Pramipexole} (\textbf{Mirapex}) 
                    \begin{coloredlist}
...
\begin{coloredlist}
    ...
    \item Antagonist
    \begin{coloredlist}
        \item \cyanit{Resperpine} (\textbf{Raudixin})
    ...
    \begin{coloredlist}
        \item SSRIs
        \begin{coloredlist}
            \item \cyanit{Fluoxetine} (\textbf{Prozac})
            \item \cyanit{Paroxetine} (\textbf{Paxil})
            \item \cyanit{Sertraline} (\textbf{Zoloft})
            \item \cyanit{Escitalopram} (\textbf{Lexapro, Cipralex})
        \end{coloredlist}
        \item SNRIs
        \begin{coloredlist}
            \item \cyanit{Duloxetine} (\textbf{Cymbalta})
            \item \cyanit{Desvenlafaxine} (\textbf{Pristiq})
        \end{coloredlist}
        \item Triple uptake inhibitors (SNDRIs)
        \item 5-HT, NE, and DA
        \begin{coloredlist}
            \item \cyanit{Venlafaxine} (\textbf{Effexor}) (originally thought to be SNRI)
        \end{coloredlist}
        ...
        \begin{coloredlist}
            ...
            \begin{coloredlist}
                ...
                \item \cyanit{Nefazodone} (\textbf{Serzone}) -- Liver problems
            \end{coloredlist}
        \end{coloredlist}
    \end{coloredlist}
\end{coloredlist}
...
\begin{coloredlist}
    ...
    \begin{coloredlist}
        ...
        \item \cyanit{Geniprone} (\textbf{Exxua}) -- New glutamate antagonist that fine-tunes glutamate.
    \end{coloredlist}
    \item BUT also
    \begin{coloredlist}
        \item \cyanit{SNDRAs} -- Serotonin Norepinephrine Dopamine Releasing Agents
    \end{coloredlist}
\end{coloredlist}
...
\begin{coloredlist}
    \item \cyanit{Buproprion} (\textbf{Wellbutrin}) 
    \begin{coloredlist}
        \item Weak NDRI
