...
\newtcolorbox{wordbox}[1][]{%
  ...
  colback=black!80,        % dark background
  coltitle=draculafg,          % title in white
  coltext=draculafg,           % main text in white
  title={\large \textbf{Choices}},
  attach boxed title to top left={xshift=0.5cm},
  boxed title style={colback=black!60}, % slightly lighter background for the title box
  #1
}
...
\vspace*{-0.25in}
\input{Chapters/behavioral_psychophis_video_lab}

\chapter{Lab 3: Sleep Lab}
\vspace*{-0.25in}
\input{Chapters/behavioral_sleep_lab}
...
% \vspace*{-0.25in}
% \input{Chapters/behavioral_quiz_2_ANSWER_KEY}
