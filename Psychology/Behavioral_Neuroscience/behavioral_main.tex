...
\colorlet{firstlevel}{xrainbow0}
\colorlet{secondlevel}{xrainbow1}
\colorlet{thirdlevel}{xrainbow2}
\colorlet{fourthlevel}{xrainbow3}
\colorlet{fifthlevel}{xrainbow4}
\colorlet{sixthlevel}{xrainbow5}
...
% Do not use all caps.
\newcommand{\titlestandin}[0]{Behavioral Neuroscience}
