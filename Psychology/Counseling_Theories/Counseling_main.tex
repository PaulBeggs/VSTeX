...
% Do not use all caps.
\newcommand{\titlestandin}{Counseling Theories \& Practice}
\newcommand{\cussubtitle}{PSYC 243}
...
% \vspace*{-0.25in}
% \input{Chapters/Counseling_ch_1}

% \setcounter{chapter}{1}
% \chapter{The Counselor: Person and Professional}
% \vspace*{-0.25in}
% \input{Chapters/Counseling_ch_2}

% \chapter{Ethical issues in Counseling}
% \vspace*{-0.25in}
% \input{Chapters/Counseling_ch_3}

% \chapter{Psychoanalytic Therapy}
% \vspace*{-0.25in}
% \input{Chapters/Counseling_ch_4}

% \setcounter{chapter}{5}
% \chapter{Existential Therapy}
% \vspace*{-0.25in}
% \input{Chapters/Counseling_ch_6}

% \setcounter{chapter}{6}
% \chapter{Person-Centered Therapy}
% \vspace*{-0.25in}
% \input{Chapters/Counseling_ch_7}

% \setcounter{chapter}{7}
% \chapter{Gestalt Therapy}
% \vspace*{-0.25in}
% \input{Chapters/Counseling_ch_8}

% \setcounter{chapter}{8}
% \chapter{Behavior Therapy}
% \vspace*{-0.25in}
% \input{Chapters/Counseling_ch_9}

% \setcounter{chapter}{9}
% \chapter{Cognitive Behavioral Therapy}
% \vspace*{-0.25in}
% \input{Chapters/Counseling_ch_10}

\chapter{Polarizing Topics}
\vspace*{-0.25in}
\input{Chapters/polarizing_topics.tex}
