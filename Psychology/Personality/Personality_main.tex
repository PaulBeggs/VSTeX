...
% Do not use all caps.
\newcommand{\titlestandin}[0]{Personality Notes}
\newcommand{\cussubtitle}[0]{PSYC 370}
% Date format should be like: "January 1, 2001"
% \newcommand{\startdate}[0]{January 21, 2025}
\newcommand{\startdate}[0]{\today}
% \newcommand{\customenddate}[0]{May 14, 2025}
\newcommand{\customenddate}[0]{\today}
% Be sure to include degree recognition (e.g., B.S., M.S., Ph.D)
\newcommand{\professor}[0]{Prof. Sarah Root, Ph.D.}
...
% \section*{Personality Exploration}
% % \vspace*{-0.25in}
% \input{Notes/Personality_Exploration.tex}


% \setcounter{chapter}{0}
% \chapter{What is Personality?}
% \vspace*{-0.25in}
% \input{Notes/Chapters/personality_ch_1}

% \setcounter{chapter}{1}
% \chapter{Research Methods}
% \vspace*{-0.25in}
% \input{Notes/Chapters/personality_ch_2}

% \setcounter{chapter}{2}
% \chapter{The Psychoanalytic Approach}
% \vspace*{-0.25in}
% \input{Notes/Chapters/personality_ch_3}

% \setcounter{chapter}{3}
% \chapter{The Freudian Approach (R. Research)}
% \vspace*{-0.25in}
% \input{Notes/Chapters/personality_ch_4}

% \setcounter{chapter}{4}
% \chapter{The Neo-Freudian Approach}
% \vspace*{-0.25in}
% \input{Notes/Chapters/personality_ch_5}

\setcounter{chapter}{6}
\chapter{The Trait Approach}
\vspace*{-0.25in}
\input{Notes/Chapters/personality_ch_7}

\setcounter{chapter}{7}
\chapter{The Trait Approach (Relevant Research)}
\vspace*{-0.25in}
\input{Notes/Chapters/personality_ch_8}

\setcounter{chapter}{7}
\chapter{The Biological Approach}
\vspace*{-0.25in}
\input{Notes/Chapters/personality_ch_9}
