...
\setlength{\headheight}{15pt} % Adjust accordingly if you have a tall header
...
% Create the custom definition environment
...
% Command to link specific words within the definition
...
\newenvironment{proofpart}[2][black]{
    ...
    \noindent
    \begin{minipage}[t]{0.08\textwidth} % Adjust width as needed
        \textbf{#2} % The label for the implication (Rightarrow or Leftarrow)
    \end{minipage}%
    \begin{minipage}[t]{0.90\textwidth} % Adjust width as needed
        \begin{adjustwidth}{0pt}{0pt} % No additional indentation
}{
    \end{adjustwidth}
    \end{minipage}
    \end{mdframed}
