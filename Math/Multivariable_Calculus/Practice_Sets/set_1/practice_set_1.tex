...
\begin{enumerate}
          ...
          \begin{enumerate}
              ...
              \item (2 points) Set up -- but do not evaluate! -- the integral necessary to determine the arc length for this curve. Then, use your calculator to approximate this integral to 3 decimal places. \\
                    ...
                    \sol{
                        ...
                        \]
                        If we approximate \(\pi\) to 3 decimal places, we get \(3.142\).
                    }
          ...
          \begin{enumerate}
              ...
              \item Suppose that we find scalars \(c\) and \(d\) such that \(c\mathbf{v} + d\mathbf{w} = \mathbf{0}\). Show that \(c = 0\) and \(d = 0\).
                    \sol{
                        ...
                        \textbf{Without using Linear Algebra:}

                        From the system of equations, we can solve for \(c\) in terms of \(d\):
                        \[
                            3c + 2d = 0 \implies 3c = -2d \implies c = -\frac{2}{3}d.
                        \]
                        Substituting this into the second equation:
                        \[
                            -\frac{2}{3}d - d = 0 \implies -\frac{5}{3}d = 0 \implies d = 0.
                        \]
                        Substituting this back into the first equation:
                        \[
                            3c + 2(0) = 0 \implies 3c = 0 \implies c = 0.
                        \]
                    }
          \end{enumerate}
          \newpage
          ...
          \begin{enumerate}
              ...
              \item Determine \(\mathbf{u} \times \mathbf{v}\).
                    ...
                    \[
                        \mathbf{u} \times \mathbf{v} = \begin{vmatrix}
                            ...
                            6          & 2          & -5         \\
                            -4         & 1          & -7
                        \end{vmatrix} = \brackett{[2(-7) - (-5)(1)], \ - [6(-7) - (-5)(-4)], \ [6(1) - 2(-4)]} = \brackett{-9,62,14}.
                    \]
                    }
              \item What is the angle between \(\mathbf{u}\) and \(\mathbf{v}\)? [An answer, in radians rounded to 3 decimal places, is appropriate here.]
                    \sol{
                        ...
                        \]
                        Thus, \(\theta \approx \cos^{-1}(0.198) \approx 1.371\) radians.
                    }
    ...
    \item (2 points) Find the general form of an equation of the plane which contain the three points \(P = (3,1,-4)\), \(Q = (-2,0,5)\) and \(R = (4,-6,1)\).
          \sol{
          To find the general form of the equation of the plane, we can use the cross product of two vectors that lie in the plane. Let \(\mathbf{PQ} = \brackett{-2 - 3,0 - 1,5 + 4} = \brackett{-5,-1,9}\) and \(\mathbf{QR} = \brackett{4 + 2,-6 - 0,1 - 5} = \brackett{6,-6,-4}\). Then, the normal vector to the plane is given by
          \[\mathbf{PQ} \times \mathbf{QR} = \begin{vmatrix}
                  \mathbf{i} & \mathbf{j} & \mathbf{k} \\
                  -5         & -1         & 9          \\
                  6          & -6         & 4
              \end{vmatrix} = \brackett{[(-1)(4) - 9(-6)], \ -[(-5)(4) - 9(6)], \ [(-5)(-6) - (-1)(6)]} = \brackett{50,74,24}.
          \]
          Thus, \(\mb{n} = \brackett{50,74,24}\) and we can choose the following points to make the equation of the plane:
          \[
              50(x - 3) + 74(y - 1) + 24(z + 4) = 0.
          \]
          }
    \item (2 points) Find an equation, in symmetric form, of the line of intersection between the planes \(2x + y - z + 4 = 0\) and \(x - y + 3z = 1\).
          \sol{
              ...
              \[
                \frac{x + 1}{2} = \frac{y + 2}{-7} = \frac{z}{-3}.
              \]
          }
\end{enumerate}
