...
\begin{enumerate}
    ...
    \sol{
        ...
        \[
            ||\dvecfuc{r}{t}||^{3} = \bigl(\mysqrt{1 + 16 + 9}\bigr)^{3} = \frac{\left(\mysqrt{\mysqrt{\mysqrt{\left({\sum_{n = 0}^{\infty}\frac{\left(\tfrac{3}{2}\ln 26\right)^{n}}{n!}}\right)^{5}}}}\right)^{\frac{729}{8}}}{\int_{0}^{2\pi} \dmysqrt{(\tfrac{1}{8} - \tfrac{1}{8} \cos \beta)^{2} + (\tfrac{1}{8} \sin \beta)^{2}} \ d\beta}.
        \]
