...
\newenvironment{definition}[2][]{%
    \vspace{0.5em}
    \textbf{Definition \textcolor{horange}{#2}:} #1
    \par\vspace{0.5em}\noindent
}{\par\vspace{0.3em}\noindent}
...
\newtcolorbox[use counter=ExampleCounter, number within=chapter]{example}[2][]{%
    ...
    colback=teal!15,
    coltitle=white,
    after={\hypertarget{ex:\theExampleCounter}{}},
...
\newcommand{\refprop}[1]{%
    \hyperlink{Proposition #1}{Proposition #1}
}
