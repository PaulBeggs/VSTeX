\begin{exercise}
    {2.3} Let \(g\) be a \hyperref[sec:DLP]{primitive root} for \(\mathbb{F}_p\).
    \begin{enumerate}
...
\begin{exercise}
    {2.17} Use Shanks's babystep-giantstep (\refprop{2.21}) method to solve the following discrete logarithm problems.
    \begin{enumerate}
...
\begin{exercise}
    {2.28} Use the \hyperref[Pohlig-Hellman]{Pohlig-Hellman algorithm} (Theorem 2.31) to solve the discrete logarithm problem \(g^x = a\) in \(\mathbb{F}_p\) in each of the following cases.
    \begin{enumerate}
