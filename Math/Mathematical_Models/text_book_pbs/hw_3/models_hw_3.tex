...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item Find the editorial and sales budget figures that maximize profit. Assume that the subscription price remains at \$1.50/week, and the advertising price stays at \$250/page. Use the five-step method, and model as a constrained optimization problem. Solve using the method of Lagrange multipliers.
        \setcounter{enumii}{2}
        \item Draw a graph of the feasible region for this problem. Indicate the location of the optimal solution on this graph. Which of the constraints are binding at the optimal solution? How is this related to the shadow prices?
    \end{enumerate}
\end{enumerate}
...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item Show that the pig is gaining about 5 lbs/day at \(t = 0\). What happens as \(t\) increases?
        \item Find the optimal time to sell the pig. Use the five-step approach, and model as a one–variable optimization problem.
    \end{enumerate}
    \setcounter{enumi}{9}
    \item Reconsider the newspaper problem of Exercise 7 in Chapter 2, but now suppose that we choose to maximize our profit margin (profit as a percentage of revenue). Assume that our business expenses remain fixed at \$200,000 per week.
    \begin{enumerate}
        \setcounter{enumii}{1}
