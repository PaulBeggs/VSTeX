...
% Do not use all caps.
\newcommand{\titlestandin}[0]{Final Portfolio}
\newcommand{\cussubtitle}[0]{MATH 420}
...
\newcommand{\professor}[0]{Dr. Carol Ann Downes}
...
\chapter{Summary Page}\label{summary}
\vspace*{-0.25in}
\input{chapters/seminar_theme_summary.tex}
\setcounter{chapter}{1}

\chapter{Portfolio Items}
\vspace*{-0.25in}
\input{chapters/portfolio_items.tex}
