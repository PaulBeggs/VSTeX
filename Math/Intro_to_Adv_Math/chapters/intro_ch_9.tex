\subsection{Recursion and the Whole Numbers}
...
% ------------------------------------------------------------------------------
            ...
            \pb{
                (Commutativity) Suppose $m,n\in \W$. Then, $$n + m = m + n$$ (Important: Must use proof by induction and the previous two problems in proof.)
            }
    ...
    \subsection{Multiplication}
        ...
        \subsubsection{Corollary to Theorem 8 (unofficial corollary)}

            \begin{corollary}
                Suppose $m \in \W$. Then, $$p_0(m) = 0 \text{ and } p_m(0) = 0$$
            \end{corollary}

            \expf{
                Suppose $m\in \W$. By the definition of multiplication, we know that $m \cdot 0 = 0$. Additionally, because we know that multiplication is communicative by Theorem 8, we can rewrite the expression as $0 \cdot m = 0$. Then, using the definition of multiplication, we can rewrite these expressions as, $p_0(m) = 0$ and $p_m(0) = 0$. \\
