...
% ------------------------------------------------------------------------------
        ...
        \subsubsection{Natural Numbers}
            ...
            \begin{definition}
                The set of \textit{natural numbers}, denoted $\N$, is the set $\W \backslash \{0\} = \{1,2,3,\dots\}$. We call the cardinality of $\N$: $|\N| := \ale$ (read ``aleph naught'').
            \end{definition}
...
% ------------------------------------------------------------------------------
            ...
            \expf{
                Suppose $f$ is the relation defined by the following: $$\text{For each $n \in \W$, map $n$ to:} 
                \begin{cases}
                    \frac{n}{2} & \text{if } n \text{ is even} \\
                    -\frac{n + 1}{2} & \text{if } n \text{ is odd and } \ne 1
                \end{cases}. \leftarrow \text{ (period)} $$
...
% ------------------------------------------------------------------------------
            ...
            \pb{
                Suppose $A$ is a set with $|A| = \ale$. Show there exists an enumeration of $A$; that is, $$A = \{a_1,a_2,\dots\}$$ where $a_i \ne a_j$ for $i \ne j$.
            }
