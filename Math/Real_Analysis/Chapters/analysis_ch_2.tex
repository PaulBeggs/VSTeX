...
\begin{example}
    {Limit Proof 3}Claim: \(\limn{\frac{2n^2 + 1}{n^2}} = 2\)
\end{example}
...
\begin{example}
    {Limit Proof 4}Claim: \(\limn{\frac{7n + 8}{3n + 6}} = \frac{7}{3} \)
\end{example}
...
\begin{example}
    {Limit Proof 5}Let \((x_n) = \displaystyle \frac{\cos(n)}{3n}\). Claim: \(\limn{(x_n)} = 0\)
\end{example}
...
\begin{example}
    {Limit Proof 6}Let \((y_n) = \frac{4n-1}{n^2}\). Claim: \(\limn{y_n} = 0\).
\end{example}
