...
\begin{example}
    Let \(g(x) = x^{2}\). Use \defref{5.1.1} to find \(g'(c)\).
\end{example}
...
\begin{example}
    Let \(g(x) = x^{3}\). Use \defref{5.1.1} to find \(g'(c)\). 
\end{example}
...
\begin{example}
    Let \(g(x) = x^{4}\). Use \defref{5.1.1} to find \(g'(c)\).
\end{example}
...
\begin{example}
    Let \(f(x) = |x|\). Use \defref{5.1.1} to find \(f'(c)\).
\end{example}
