...
\begin{exercise}
    {1.2.8}Given a function \(f \ \colon A \rightarrow B\) can be defined as either \hyperref[def:1.2.5]{one-to-one} or \hyperref[def:1.2.6]{onto}, give an example of each or state that the request is impossible:
    \begin{enumerate}
