...
Recall that an \textbf{automorphism} of a group \(G\) is an isomorphism \(\varphi \funccolon G \to G\). The \textbf{automorphism group}, \(Aut(G)\), is the group of all automorphisms on \(G\) with function composition as its operation. \\
...
\[
    \varphi \funccolon X \to Aut(A).
\]
This means that for each \(x \in X\), we have an automorphism \(\varphi_{x} \funccolon A \to A\). Since \(\varphi\) is a homomorphism, then for any \(x,y \in X\) and \(a \in A\), \(\varphi_{xy}(a) = \varphi_{x}(\varphi_{y}(a))\). Also, \(\varphi{e'} \funccolon A \to A\) is the identity map on \(A\). \\
...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item \textbf{Associativity:} For any \(a,b,c \in A\) and \(x,y,z \in X\), show that 
        \[
            [(a,x)(b,y)](c,z) = (a,x)[(b,y)(c,z)]
        \]
        \item \textbf{Identity:} Show that \((e,e')\) is the identity element of \(G\).
        \item \textbf{Inverses:} the inverses of \((a,x)\) is \((\varphi_{x^{-1}}(a^{-1}), x^{-1})\). 
    \end{enumerate}
    \sol{
...
\begin{enumerate}
    \setcounter{enumi}{4}
    \item Let \(\varphi \funccolon \Z_{2} \to Aut(\Z_{4})\) be defined as follows:
    \begin{align*}
        \varphi_{0} & \funccolon \Z_{4} \to \Z_{4} \text{ is the identity map: } \varphi_{0}(n) = n \\
        \varphi_{1} & \funccolon \Z_{4} \to \Z_{4} \text{ maps to inverses: } \varphi_{1}(n) = n^{-1} 
    \end{align*}
