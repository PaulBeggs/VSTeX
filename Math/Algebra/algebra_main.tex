...
% Do not use all caps.
\newcommand{\titlestandin}{Algebra Notes}
\newcommand{\cussubtitle}{MATH 320}
% Date format should be like: "January 1, 2001"
\newcommand{\startdate}{August 27, 2025}
\newcommand{\finaldate}{Decemeber 8, 2025}
