    ...
    \pf{
        ...
        \begin{itemize}
            ...
            \[
                L = pKp^{-1} = pgHg^{-1}p^{-1}.
            \]
            Notice \(pg = g''\) and \(g^{-1}p^{-1} = (pg)^{-1} = g''^{-1}\). The product \(pg\) and \((pg)^{-1}\) are both in \(G\) because \(G\) is a group. Thus, we have shown that \(H\) is conjugate to \(L\). Therefore, the relation is transitive. \qedhere
        \end{itemize}
    }
\newpage
    \setcounter{enumi}{29}
