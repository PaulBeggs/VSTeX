...
\fancyhead[R]{Presentation Problem 2}
...
\newcommand{\assignmentname}{Presentation Problem 2}
...
\begin{enumerate}
    \setcounter{enumi}{29}
    \item \(f_{1} \colon \R \to \R\) defined by \(f_{1}(x) = x + 1\).
    \sol{
        A permutation of a set is a bijective function from the set to itself. Thus, we need to check if \(f_1\) is both injective and surjective:
        \begin{itemize}
            \item \textbf{Injective:} Assume \(f_1(x_1) = f_1(x_2)\). This implies: 
            \[
            x_1 + 1 = x_2 + 1 \implies x_1 = x_2.
            \]
            Thus, \(f_1\) is injective.
            \item \textbf{Surjective:} Let \(y \in \R\) be arbitrary. We need to find \(x \in \R\) such that \(f_1(x) = y\):
            \[
            f_1(x) = x + 1 = y \implies x = y - 1.
            \]
            Because \(y - 1 \in \R\), \(f_1\) is surjective.
        \end{itemize}
        Therefore, \(f_1\) is a permutation of \(\R\).

    }
    \item \(f_{2} \colon \R \to \R\) defined by \(f_{2}(x) = x^{2}\).
    \sol{
        This function is not a permutation because it is not injective. For example, \(f_{2}(1) = 1^{2} = 1\) and \(f_{2}(-1) = (-1)^{2} = 1\), but \(1 \neq -1\).
    }
    \item \(f_{3} \colon \R \to \R\) defined by \(f_{3}(x) = - x^{3}\).
    \sol{
        \begin{itemize}
            \item \textbf{Injective:} Assume \(f_3(x_1) = f_3(x_2)\). This implies:
            \[
                -x_1^3 = -x_2^3 \implies x_1^3 = x_2^3 \implies x_1 = x_2.
            \]
            Hence, \(f_{2}\) is injective.
            \item \textbf{Surjective:} Let \(y \in \R\) be arbitrary. We need to find \(x \in \R\) such that \(f_3(x) = y\):
            \[
                f_3(x) = -x^3 = y \implies x^3 = -y \implies x = \sqrt[3]{-y}.
            \]
            Since \(\sqrt[3]{-y} \in \R\) for any \(y \in \R\), \(f_3\) is surjective.
        \end{itemize}
        Therefore, \(f_3\) is a permutation of \(\R\).
    }
    \newpage
    \item \(f_{4} \colon \R \to \R\) defined by \(f_{4}(x) = e^{x}\).
    \sol{
        This function is not a permutation because it is not surjective. That is, \(e^{x}\) is always positive for all \(x \in \R\), so there is no \(x \in \R\) such that \(f_{4}(x) = -1\), for example.
    }
    \item \(f_{5} \colon \R \to \R\) defined by \(f_{5}(x) = x^{3} - x^{2} - 2x\).
    \sol{
        This function is also not a permutation because it is not injective. For example, \(f_{5}(0) = 0^{3} - 0^{2} - 2 \cdot 0 = 0\) and \(f_{5}(2) = 2^{3} - 2^{2} - 2 \cdot 2 = 8 - 4 - 4 = 0\), but \(0 \neq 2\).
    }
\end{enumerate}
