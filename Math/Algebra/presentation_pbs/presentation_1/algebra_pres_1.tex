...
\begin{enumerate}
    ...
    \item All \(n \times n\) upper-triangular matrices under matrix multiplication.
          ...
          \sol{
              The set of all \(n \times n\) upper-triangular matrices under matrix multiplication does not form a group because it fails \(\mathcal{G}_{3}\). A counterexample is the upper-triangular matrix
              \[
                  A = \begin{bmatrix}
                      1 & 0 \\
                      0 & 0
