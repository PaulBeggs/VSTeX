    ...
    \begin{enumerate}
        ...
        \sol{
            \begin{align*}
                ...
                &= \int_{0}^{1} 6x^{7} - \frac{72}{7}x^{6} + \frac{216}{49}x^{5} \, dx \\
...
\newpage
    ...
    \begin{enumerate}
        ...
        \sol{
            ...
            \begin{align*}
                \left[ {uv} \right]_{1}^{\infty} - \int_{1}^{\infty} vdu &= \left[ {-\frac{\ln(x)}{x}} \right]_{1}^{\infty} + \int_{1}^{\infty} \frac{1}{x^{2}} \, dx \\
...
\newpage
	...
	\begin{enumerate}
		...
		\sol{
            \[
                \pi_{0.90} = invNorm(.9, 30, 4.3, \text{LEFT}) = 35.5107.
            \]
		}
	\end{enumerate}
\end{enumerate}
