...
\begin{header}
    ...
    \AND%
    \kern 0.25 cm%
    \mbox{\hrefWithoutArrow{mailto:paulbeggs03@gmail.com}{paulbeggs03@gmail.com}}%
    \kern 0.25 cm%
    \AND%
    \kern 0.25 cm%
    \mbox{\hrefWithoutArrow{tel:(573)587-9258}{(573)587-9258}}%
    \kern 0.25 cm%
    \AND%
    \kern 0.25 cm%
    ...
    % \AND%
    \kern 0.25 cm%
    \mbox{\hrefWithoutArrow{https://www.linkedin.com/in/paul-beggs/}{www.linkedin.com/paul-beggs}}%
    \kern 0.25 cm%
    % \AND%
    % \kern 0.25 cm%
...
\section{Additional Experience and Activities}
