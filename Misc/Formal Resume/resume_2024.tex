...
\begin{onecolentry}
    \begin{highlights}
        \item Participated in an intensive program specifically designed for intervening for people who are suicidal.
...
\begin{onecolentry}
    \begin{highlights}
        \item Recognized for academic excellence and commitment to education.
    \end{highlights}
\end{onecolentry}
