...
\expf{
    For the sake of contradiction, assume \(F\) is not empty; that is, there exists distinct points \(x_{1},x_{2} \in A\) such that \(g(x_{1}) = g(x_{2})\).
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[
                ...
                mark size=3pt,
                color=red,
            ] coordinates { (-2.7515,6) (-0.84108,6) (-1.23774, 8.3)};

            \node[above right, red] at (axis cs:-1.23774, 8.3) {\(c\)};
            ...
            \draw[dotted, lightgray, thick] (axis cs:-4.5,10.05105) -- (axis cs:7,10.05105);
            \draw[dotted, lightgray, thick] (axis cs:-4.5,-5.2362) -- (axis cs:7,-5.2362);
