...
\fancyhead[C]{\includegraphics[height=.50cm]{images/small logo_white.png}}
\usepackage{xpatch}
...
% Do not use all caps.
\newcommand{\titlestandin}[0]{Mathematical Cryptography Notes}
...
\input{Exercises/crypt_exercises_1}
...
\input{Exercises/crypt_exercises_5}
\addcontentsline{toc}{chapter}{Exercises 5}


\chapter*{Exercises pt. 6}\label{ex 6}
\vspace*{-0.25in}
\fancyhead[R]{Exercises 6}
\input{Exercises/crypt_exercises_6}
