...
\sol{
    ...
    \footnotetext{\(\phantom{0}^{1}\)A Google search with the decrypted words led me to the plaintext in proper grammatical form with capitalization and proper spacing.}
}
\newpage
