...
\lesol{
    \begin{enumerate}[itemsep=5pt, parsep=0pt, topsep=2pt, partopsep=0pt]
...
\sol{
    ...
    \[
        x_{1} = a_{0} + 16a_{1} \implies x_{1} = 15 \pmod{16}, \qquad x_{2} = b_{0} + 27b_{1} \implies x_{2} = 20 \pmod{27}
    \]
    % \begin{align*}
    %     x_1 & =  a_0 + 16a_1 \\
    %     x_1 & = 15 \pmod{16}
