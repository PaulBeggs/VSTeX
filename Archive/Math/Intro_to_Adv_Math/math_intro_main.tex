...
\newcommand{\documentTheme}{draculabg}
\newcommand{\documentFont}{draculafg}
...
% \newcommand{\documentFont}{black}
% \newcommand{\documentTheme}{white}
...
\ChTitleVar{\bfseries\scshape\color{\documentFont}} % Needed for Dracula theme
\ChNumVar{\large\selectfont\color{\documentFont}} % Needed for Dracula theme
\ChNameVar{\large\color{\documentFont}} % Needed for Dracula theme
\usepackage{xpatch}
...
% \newcommand{}{\marginnote{\includegraphics[width=2em]{./Math/Intro_to_Adv_Math/images/caution.png}}}
...
\newmdenv[
  ...
  backgroundcolor=\documentTheme, % Needed for Dracula theme
  fontcolor=\documentFont, % Needed for Dracula theme
  innertopmargin=0pt,
...
\newcommand{\professor}[0]{Prof. Carol Ann Downes}
