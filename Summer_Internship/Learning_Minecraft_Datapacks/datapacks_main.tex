...
\newcommand{\documentLogo}{images/output_image_transparent_bg.png}
\newcommand{\documentBigLogo}{images/output_image_transparent_bg.png}
...
% Do not use all caps.
\newcommand{\titlestandin}{Minecraft Data Packs}
\newcommand{\cussubtitle}{Notes \& Code Snippets}
% Date format should be like: "January 1, 2001"
\newcommand{\startdate}{April 2, 2025}
\newcommand{\customenddate}{TBD}
...
\begin{titlepage}
    \begin{center}
        ...
        \vspace*{-2cm}
        % TikZ image goes here.
        \includegraphics[width=0.6\textwidth]{\documentBigLogo}\\ % Use for Dracula. Its the all white version of the logo.
        \vfill
...
\vspace*{-0.25in}
\input{chapters/the_basics.tex}


\setcounter{chapter}{1}
\chapter{Armor Stand Coding}\label{ch:armor_stand_coding}
\vspace*{-0.25in}
\input{chapters/armor_stand_coding.tex}
