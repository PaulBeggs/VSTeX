...
\newcommand{\documentLogo}{images/ML_logo.png}
\newcommand{\documentBigLogo}{images/ML_logo.png}
...
% Do not use all caps.
\newcommand{\titlestandin}{Machine Learning}
\newcommand{\cussubtitle}{Notes, Math, and Examples}
...
\begin{titlepage}
    \begin{center}
        ...
        \vspace*{-2cm}
        \includegraphics[width=0.7\textwidth]{\documentBigLogo}\\ 
        \vfill
...
% -%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%
\chapter{Latent Spaces}\label{ch:latent_spaces}
\vspace*{-0.25in}
\input{Chapters/Latent_Spaces.tex}
