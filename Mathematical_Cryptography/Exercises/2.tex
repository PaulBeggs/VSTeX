...
\begin{enumerate}
    \item \begin{enumerate}[label=(\roman*)]
        ...
        \begin{align*}
            ...
            11^{45} & \ (\text{mod } 47)
        \end{align*}
        By the fast power algorithm, we need to find the binary representation of 45. Thus, $45 \ (\text{mod } 2) = 1$, $22 \ (\text{mod } 2) = 0$, $11 \ (\text{mod } 2) = 1$, $5 \ (\text{mod } 2) = 1$, $2 \ (\text{mod } 2) = 0$, $1 \ (\text{mod } 2) = 1$. From this, we have the binary representation of $45_{10}z$ as $101101_2$. Hence, we will need to calculate $2^5 \cdot 2^3 \cdot 2^2 \cdot 2^1 \cdot 2^0 \Rightarrow 11^{2^5} \cdot 11^{2^3} \cdot 11^{2^0} \Rightarrow 11^{32} \cdot 11^8 \cdot 11^4 \cdot 11 \equiv 17 \cdot 14 \cdot 25 \cdot 11$. Now, lets find the values of these numbers:
        \begin{align*}
