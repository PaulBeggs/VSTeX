...
\newtcolorbox[]{exercise}[2][]{%
    ...
    before={\setstretch{1}}, % Set line spacing to 1 before the box content
    after={\setstretch{1}},  % Reset line spacing after the box content
    #1,
}


%% Examples %%
% need to add counter here: use counter=boxcounter
